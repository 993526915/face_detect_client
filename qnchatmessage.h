...
class QNChatMessage : public QWidget
{
    Q_OBJECT
public:
    explicit QNChatMessage(QWidget *parent,QString sendTouXiang,QString receiveTouXiang);
    ...
    void setTextSuccess();
    void setText(QString text, time_t time, QSize allSize, User_Type userType);
